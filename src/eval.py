...
test_data_path = "absa_test.jsonl"
...
print(f"Starting inference on {len(test_lines)} examples...")
...
for line in tqdm(test_lines):
    ...
    # Force the output into strict categories to calculate math cleanly
    if "positive" in raw_prediction:
        ...
        # If the model hallucinates something weird, mark it as invalid
        y_pred.append("invalid")

# ==========================================
# 4. Final Advanced Metrics
# ==========================================
print("\n" + "="*60)
print("🧠 MISTRAL ABSA - FINAL EVALUATION METRICS")
print("="*60)
